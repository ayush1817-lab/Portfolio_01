...
export function UxShelf() {
  ...
  return (
    <section
      ...
      className="snap-start border-b border-[color:var(--color-ink)]/10 bg-[color:var(--color-paper-2)] py-6 md:py-10 lg:py-24"
    >
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:gap-14">
          <div className="lg:sticky lg:top-24 lg:w-80 lg:shrink-0">
            <SectionTitle
              index="UX / 03"
              title="Case studies."
              caption="Three UX project overviews — swipe to browse."
            />
          </div>
              ...
              {previewCases.map((c, i) => {
                ...
                return (
                  <Card
                    ...
                    draggable={false}
                    className={cn(
                      "group relative flex h-[240px] w-[62vw] max-w-[240px] shrink-0 flex-col border border-[color:var(--color-ink)] bg-[color:var(--color-paper)] transition-transform duration-300 lg:h-[420px] lg:w-[340px] lg:max-w-[360px]",
                      c.link && "hover:-translate-y-1",
                    )}
                  >
